...
export const HELP_SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Frame, fill and font", body: "Right-click for Fill Colour, Frame Colour (grey by default) and Font Size. The toolbar A- / A+ buttons resize the labels of everything selected." },
      { label: "Progress", body: "Right-click and pick Progress to shade part of a bar as complete." },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Legend and templates", body: "Show legend adds a colour key inside the chart, so it appears in exports. Start from a template fills a chart with a starting shape." },
    ],
  },
];
