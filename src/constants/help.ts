...
export const HELP_SECTIONS: HelpSection[] = [
  {
    ...
    items: [
      ...
      { label: "Topics", body: "The tags button in the toolbar shows the narrow sideways column at the edge of the chart. The row names underneath always stay separate cells." },
