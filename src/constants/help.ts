...
export const HELP_SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Colour", body: "Right-click and choose Colour. One palette laid out as a grid - a row per hue, a column per tone from 100 to 900 - with Fill and Frame tabs above it. The dot on each tab shows what that tab currently holds." },
